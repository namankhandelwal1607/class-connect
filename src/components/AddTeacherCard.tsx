...
//   console.log(userid);
  ...
  const sendData = async () => {
    ...
    try {
      const response = await axios.post("https://classroom-api-bice.vercel.app/addTeacherInClass", data);
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    console.log("Class Name:", teacherName);
    sendData();
  };
